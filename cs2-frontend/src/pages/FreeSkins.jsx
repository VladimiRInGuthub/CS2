...
/**
 * Page FreeSkins - Galerie de skins utilisant des APIs gratuites
 */
const FreeSkins = () => {
          ...
          <div style={{
            ...
            <div style={{ color: '#fff' }}>
              ...
              <div style={{ 
                ...
                <h4 style={{ color: '#00ff88', marginBottom: '10px' }}>📡 Source des données</h4>
                <div style={{ fontSize: '0.9rem', color: '#cfcfff' }}>
                  <div>• Images: Steam Community</div>
                  <div>• Données: Base locale + APIs gratuites</div>
                  <div>• Prix: Estimations du marché</div>
                </div>
              </div>
